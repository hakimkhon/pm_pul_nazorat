            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [AppTheme.brandPrimary(context), AppTheme.brandPrimary(context).withValues(alpha: 0.75)],
                    ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              userName.isNotEmpty ? userName : 'Ismingizni kiriting',
                              style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 16),
                            ),
                            Text('PulNazorat foydalanuvchisi',
              ...
              _SettingsCard(
                child: Column(
                  ...
                  children: [
                    ...
                    _SegmentedRow(
                      options: const {'Tizim': ThemeMode.system, 'Yorug\'': ThemeMode.light, 'Qorong\'i': ThemeMode.dark},
                      selected: themeMode,
                    ...
                    const SizedBox(height: 10),
                    _SegmentedRow(
                      options: const {'Kichik': 0.9, 'O\'rta': 1.0, 'Katta': 1.1, 'Juda katta': 1.2},
                      selected: fontScale,
                      onSelect: (s) => ref.read(fontScaleProvider.notifier).setScale(s),
                    ),
                  ],
                ),
              ),
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('Limitning 80%/100%iga yetganda xabar bering',
                                  style: Theme.of(context).textTheme.labelSmall),
                            ],
                          ),
                        ),
                        Switch(
                          ...
                          onChanged: (v) => ref.read(budgetAlertsEnabledProvider.notifier).setValue(v),
                        ),
                      ],
                    ),
                  ],
              ...
              _Tile(
                ...
                onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Hozircha faqat o\'zbek tili mavjud')),
                ),
              ),
              const SizedBox(height: 8),
              ...
              _Tile(
                ...
                onTap: () => Share.share('PulNazorat — shaxsiy moliyani boshqarish ilovasi. Sinab ko\'ring!'),
              ),
              _Tile(
                ...
                onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Play Store havolasi tez orada qo\'shiladi')),
                ),
              ),
              _Tile(
  ...
  void _editName(String current) {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: TextField(controller: controller, autofocus: true, decoration: const InputDecoration(labelText: 'Ism')),
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Bu funksiya keyingi bosqichda ulanadi')),
              );
            },
            child: Text('Tozalash', style: TextStyle(color: AppTheme.brandExpense(context))),
          ),
        ],
      ),
    );
...
class _SegmentedRow<T> extends StatelessWidget {
  ...
  const _SegmentedRow({required this.options, required this.selected, required this.onSelect});
